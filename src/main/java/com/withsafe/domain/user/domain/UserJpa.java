...
@Entity
@Table(name = "Member")
public class UserJpa extends BaseTimeEntity {
    ...
    @Builder
    public UserJpa(Long id, String name, Integer age, String phoneNum, String emergency_contact, String emergency_relation,
                ...
                Double heartDisease, DepartmentJpa department) {
        this.id = id;
        this.name = name;
        this.age = age;
