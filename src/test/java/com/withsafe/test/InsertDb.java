...
//import com.withsafe.domain.admin.domain.AdminJpa;
...
//    @Test
//    public void Admin넣기(){
//        DepartmentJpa departmentJpa = departmentRepository.findByName("SBSystems").orElseThrow();
//        DepartmentJpa departmentJpa1 = departmentRepository.findByName("A-Department").orElseThrow();
//        adminRepository.save(makeAdmin("User-A", Authority.ROLE_MASTER, "testId1", "testPwd1", departmentJpa));
//        adminRepository.save(makeAdmin("User-B", Authority.ROLE_SLAVE, "testId2", "testPwd2", departmentJpa1));
//    }
//
//    @Test
//    public void User넣기(){
...
//        DepartmentJpa departmentJpa = departmentRepository.findByName("A-Department").orElseThrow();
//        User user = userRepository.findByName("hi").get(0);
//        User user2 = userRepository.findByName("hi2").get(0);
//
//        watchRepository.save(makeWatch(1, true, "testModel", "testSerial", departmentJpa, helmet, user));
//        watchRepository.save(makeWatch(2, true, "testModel2", "testSerial2", departmentJpa, helmet1, user2));
//    }
//
//    @Test
...
//        DepartmentJpa departmentJpa1 = departmentRepository.findByName("A-Department").orElseThrow();
//
//        warningMessageRepository.save(makeWarningMessage("testWarningMessage", WarningMessageType.HEART, departmentJpa));
//        warningMessageRepository.save(makeWarningMessage("testWarningMessage2", WarningMessageType.DANGER_ZONE, departmentJpa1));
//    }
//
//    @Test
...
//        DepartmentJpa departmentJpa1 = departmentRepository.findByName("A-Department").orElseThrow();
//
//        outdoorMapRepository.save(makeOutdoorMap("testOutdoorMap", departmentJpa));
//        outdoorMapRepository.save(makeOutdoorMap("testOutdoorMap2", departmentJpa1));
//    }
//
//    @Test
...
//        DepartmentJpa departmentJpa1 = departmentRepository.findByName("A-Department").orElseThrow();
//
//        indoorMapRepository.save(makeIndoorMap("testImage", "testName", departmentJpa));
//        indoorMapRepository.save(makeIndoorMap("testImage2", "testName2", departmentJpa1));
//    }
//
//    @Test
...
//    }
//
//    private DepartmentJpa makeDepartment(String name){
//        return DepartmentJpa.builder().name(name).build();
//    }
//
//    private AdminJpa makeAdmin(String name, Authority authority, String login_id, String loginPassword, DepartmentJpa departmentJpa){
//        return AdminJpa.builder().name(name).authority(authority).loginId(login_id).loginPassword(loginPassword).department(departmentJpa).build();
//    }
//
...
//    }
//
//    private BioDataJpa makeBioData(int c, int hr, boolean iF, double ox, double tm, int wc, User user){
//        return BioDataJpa.builder().calorie(c).heartRate(hr).isFall(iF).oxygen(ox).temperature(tm).walkCount(wc).user(user).build();
//    }
//
...
//    }
//
//    private Watch makeWatch(int dn, Boolean is, String model, String serial, DepartmentJpa departmentJpa, Helmet helmet, User user){
//        return Watch.builder().deviceNum(dn).is_used(is).model(model)
//                .serialNum(serial).department(departmentJpa).helmet(helmet).user(user).build();
//    }
//
...
//    }
//
//    private WarningMessage makeWarningMessage(String content, WarningMessageType warningMessageType, DepartmentJpa departmentJpa){
//        return WarningMessage.builder().content(content).type(warningMessageType).department(departmentJpa).build();
//    }
//
...
//    }
//
//    private OutdoorMap makeOutdoorMap(String name, DepartmentJpa departmentJpa){
//        return OutdoorMap.builder().name(name).department(departmentJpa).build();
//    }
//
...
//    }
//
//    private IndoorMap makeIndoorMap(String image, String name, DepartmentJpa departmentJpa){
//        return IndoorMap.builder().imageUrl(image).name(name).department(departmentJpa).build();
//    }
//
